...
int main(int argc, char* argv[]) {
    ...
    // Load training data
    std::string train_images_path = "/home/alex/CudaNeuralNetwork/onnx_generator/data/MNIST/raw/train-images-idx3-ubyte";
    std::string train_labels_path = "/home/alex/CudaNeuralNetwork/onnx_generator/data/MNIST/raw/train-labels-idx1-ubyte";
